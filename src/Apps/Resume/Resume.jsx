      ...
      case "Project 6":
        return (
          <section>
            ...
            <h1>프로젝트 개요</h1>
            <p> React와 iTunes API를 이용해 만든 뮤직 플레이어 애플리케이션</p>
            <h1>프로젝트 기간</h1>
            <p>3일</p>
            <h1>기술 스택/협업 툴</h1>
            <p>
        ...
        return (
          <section>
            ...
            <p>
              ...
              <br></br>
              도시의 이름을 입력해서 검색하고 검색한 도시를 보여주며 도시 클릭시
              해당도시의 국가,지역,위도/경도,인구등의 자세한 정보를 보여주며
              Google Maps를 통해 위치를 볼수있는 링크를 제공합니다.
            </p>
          </section>
        );
      case "Project 10":
        return (
          <section>
            ...
            <p>
              ...
              재생됍니다, 한줄당 100점이 증가하며, 2줄이상 없어지면 콤보메세지가
              표시됩니다.
              <br></br>
              <strong>레벨 증가</strong>
              <br></br>
              ...
              <br></br>
              현재 블록이 하드드롭시 위치하는 위치를 반투명으로 미리 보여줍니다.
            </p>
          </section>
        );
      case "Project 11":
        ...
        return (
          <section>
            ...
            <p>
              ...
              <strong>전투 로직</strong>
              <br></br>
              공격시 상대의 hp를 감소시키며 방어력이 있으시 방어력이 먼저 감소후
              체력이 감소
              <br></br>
              <strong>상태 관리</strong>
              <br></br>
              ...
              1~3마리까지 랜덤으로 등장하며 스테이지가 오를때마다 적이 강해지며,
              스테이지 클리어시 골드가 주어지며, 해당 골드로는 3스테이지마다
              상점페이지가 나오며 상점에서는 게이지 증가,카드강화,장비구매등을
              할수있습니다. 또한 5스테이지마다 보스 스테이지가 등장하며 보스는
              다른 적이비해 강력합니다.
              <br></br>
              ...
              투구,무기,갑옷,신발,장갑이 있으며 종류마다 공격력,방어력,체력등이
              증가하며 항상 현재 장비보다 좋은 장비가 등장합니다.
              <br></br>
              ...
              <br></br>
              게임이 진행돼면서 그동안의 과정을 메세지로 보여주며, 버튼으로 열고
              닫을수있습니다.
            </p>
          </section>
        );
        ...
        return (
          <section>
            ...
            <p>
              ...
              <br></br>
              최근 검색기록을 로컬로 저장해서 클릭으로 빠르게 검색할수있는 기능
              <br></br>
        ...
        return (
          <section>
            ...
            <p>
              ...
              <br></br>
              api로 받아온 타입을 한글화하고, 각 타입에따라 배경색을 설정해주고
              대표타입에따라 해당 포켓몬카드의 border색상도 변화하는 기능
              <br></br>
              <strong>상세 페이지</strong>
              <br></br>각 포켓몬 카드 클릭시 상세 페이지로 전환돼며
              상세페이지에는 이미지가 gif으로 변경돼며 능력치를 추가로
              표시해주며 이전및 다음 포켓몬으로 도감순서에따라 이동할수있습니다.
            </p>
          </section>
        );
      default:
